CREATE TABLE [dbo].[ST_ALERT_RANKING_DAYTRADE_BMF] (
    [DATA] date NULL,
...
CREATE INDEX [ID001_ST_ALERT_RANKING_DAYTRADE_BMF] ON [dbo].[ST_ALERT_RANKING_DAYTRADE_BMF] ([CD_CLIENTE], [DATA]);

CREATE INDEX [ID002_ST_ALERT_RANKING_DAYTRADE_BMF] ON [dbo].[ST_ALERT_RANKING_DAYTRADE_BMF] ([DATA]);